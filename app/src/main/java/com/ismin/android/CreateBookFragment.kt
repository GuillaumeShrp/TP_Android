...
class CreateBookFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView.findViewById<View>(R.id.f_createBook_cancel).setOnClickListener {
        ...
        ObjectAnimator.ofFloat(rootView.findViewById(R.id.constraintLayout2),"translationY",300f, 0f)
            .apply {
